<template>
	<div class="_SearchFormPage">
		...
		<div class="content__title d-flex justify-between">
			<h1 class="title">Запрос на поиск транспорта</h1>
		...
		<div class="box">
			<div class="cells --gap">
				...
				<div class="cell w-8/12 l:w-12/12">
					<TransportSearchForm @success="$router.push('/support')"/>
				</div>
			</div>
		</div>
	</div>
...
export default {
	...
	head() {
		return seoCore({
			title: 'Запрос на поиск транспорта',
		}, this)
	},
	props: {},
	components: {TransportSearchForm, VBtn},
	data() {
		return {}
	},
	async asyncData({app}) {
